...
var mousemove = function(d) {
    Tooltip
      .html(`District: ${d.District} <br> The third child: ${d.Number_3} <br> Gender Ratio: ${d.Ratio_3}`)
...
var mousemove2 = function(d) {
    Tooltip
      .html(`District: ${d.properties.name} <br> The third child: ${d.properties.Number_3}<br>Gender ratio: ${d.properties.Ratio_3}`)
      .style("left", (d3.event.pageX+10) + "px")
      .style("top", (d3.event.pageY) + "px")
  }
