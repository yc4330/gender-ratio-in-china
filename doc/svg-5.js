...
var mousemove = function(d) {
    Tooltip
      .html(`District: ${d.District} <br> The fifth or more: ${d.Number_5} <br> Gender Ratio: ${d.Ratio_5}`)
...
svg.selectAll("circle")
  ...
  .enter()
  .append("circle")
    .attr("cx", function (d) { return xScale(d.Number_5)} )
    .attr("cy", function (d) { return yScale(d.Ratio_5)} )
    .attr("r", 5)
    ...
    if (yScale(d.Ratio_5) < yScale(fit_curve(d.Number_5)))
     {return colorScale(d.Ratio_5-fit_curve(d.Number_5));} 
...
var mousemove2 = function(d) {
    Tooltip
      .html(`District: ${d.properties.name} <br> The fifth or more: ${d.properties.Number_5}<br>Gender ratio: ${d.properties.Ratio_5}`)
      .style("left", (d3.event.pageX+10) + "px")
      .style("top", (d3.event.pageY) + "px")
  }
...
svg2.selectAll("path")
      ...
      .style("stroke-width", 0.5)
      .style("fill", function(d) {
    if (d.properties.Ratio_5 > fit_curve(d.properties.Number_5))
     {return colorScale(d.properties.Ratio_5-fit_curve(d.properties.Number_5));} 
    // elif d.properties.Ratio_3=null, fill with gray
    else if (d.properties.Ratio_5==null)
